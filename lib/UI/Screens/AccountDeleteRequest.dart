...
class AccountDeleteRequest extends StatefulWidget {
  const AccountDeleteRequest({super.key});

  @override
  State<AccountDeleteRequest> createState() => _AccountDeleteRequestState();
}

class _AccountDeleteRequestState extends State<AccountDeleteRequest> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse(
          'https://soulapps-bit.github.io/Delete-account-request/accountdelete.html'));
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // 1. Header Section
          _buildHeader(context, "Delete Account", "Request"),
