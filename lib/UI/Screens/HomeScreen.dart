...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _loadUserContext() async {
    ...
    if (rawId != null) {
      ...
      final pinCheck =
          await _dbRef.child('User').child(_deviceId!).child('Pin').get();
  ...
  void _showMakePinDialog(String userTag) {
    ...
    // Define the style for the individual PIN boxes
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Text("Make Pin Number",
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Text("This is your account number",
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    const Text("මෙය ඔබගේ ගිණුම් අංකයයි",
                    ...
                    // PIN Entry Section (Updated UI)
                    const Text("Create Pin number",
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    const Text("පින් අංකයක් සකස් කරන්න",
                        style: TextStyle(fontSize: 12, color: Colors.grey)),
                    ...
                    // Warning Section
                    const Text("Keep these two in your mind to recover account",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: Colors.red,
                            fontWeight: FontWeight.bold,
                            fontSize: 13)),
                    const Text(
                        "මෙම ගිණුම් අංකය සහ පින් අංකය ඔබගේ ගිණුම නැවත ලබාගැනීමේදී අවශ්‍ය බැවින් සුරක්ෂිතව තබාගන්න",
                        textAlign: TextAlign.center,
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (pinController.text.length == 5) {
                          ...
                          // Optional: Show error if PIN is incomplete
  ...
  void _checkUpdateStatus() {
    ...
    _dbRef.child('Updates').onValue.listen((event) {
      ...
      if (data != null) {
        ...
        int latestVersion = data['Version'] ?? 5;
    ...
    return Container(
      ...
      child: Container(
        decoration: BoxDecoration(
            shape: BoxShape.circle,
            border:
                Border.all(color: Colors.white.withOpacity(0.7), width: 10)),
        child: Container(
          decoration: BoxDecoration(
              color: Colors.white,
              shape: BoxShape.circle,
              border:
                  Border.all(color: Colors.white.withOpacity(0.4), width: 15)),
  ...
  Widget _buildFloatingStatsCard(BuildContext context, int correct, int wrong) {
    return Container(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: 10),
        const Text(
            "Try more quizzes and earn more points by testing your knowledge across different topics.",
            textAlign: TextAlign.center,
            style:
        ...
        Stack(clipBehavior: Clip.none, alignment: Alignment.center, children: [
          GestureDetector(
              onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const GuideVideoScreen())),
          ...
          if (_showGuidePopup)
            Positioned(
                ...
                child: Column(children: [
                  CustomPaint(
                      size: const Size(15, 10), painter: TrianglePainter()),
                  Container(
                      ...
                      child: const Column(children: [
                        Text("Click here to watch the guide",
                            style: TextStyle(
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                                color: Colors.black)),
                        Text("ඇප් එක පාවිච්චි කරන හැටි බලන්න",
                            style:
